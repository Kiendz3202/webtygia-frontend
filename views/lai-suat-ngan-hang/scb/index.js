				...
				<div className=" h-auto mt-[4.6rem] mb-[2.5rem] mx-[2.1rem] bg-white-text rounded-[1.5rem] px-[3.2rem] py-[3.2rem] shadow-shadow-custom">
					<div>
						...
						<div className=" mt-[4rem]">
							...
							<p className="text-[1.8rem] mt-[1rem] font-normal">
								SCB được hợp nhất vào năm 2012 từ ba ngân hàng
								Đệ Nhất (Ficombank), Việt Nam Tín Nghĩa
								(TinNghiaBank) và Sài Gòn (SCB) đều có trụ sở
								tại Thành phố Hồ Chí Minh. Đây là thương vụ hợp
								nhất đầu tiên trong ngành ngân hàng Việt Nam,
								đánh dấu sự bắt đầu quá trình tái cấu trúc hệ
								thống ngân hàng.
							</p>
						</div>
					</div>
