		...
		<div className="text-center mt-[40px]">
			...
			{!isOpenRedirectLogin && (
				<Link href={`${process.env.NEXT_PUBLIC_FE_URL}/authentication`}>
					<div className="flex justify-center items-center w-[150px] h-[40px] bg-green-500 mx-auto mt-[20px] rounded-[4px] text text-white text-[16px] cursor-pointer hover:opacity-80">
						Đăng nhập ngay
					</div>
				</Link>
			)}
