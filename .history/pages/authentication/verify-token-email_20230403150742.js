		...
		<div className="text-center mt-[40px]">
			...
			{!isOpenRedirectLogin && (
				<Link href={`${process.env.NEXT_PUBLIC_FE_URL}/authentication`}>
					<div className="  flex justify-center items-center w-[167px] bg-[#20e277] font-medium mx-auto mt-[20px] rounded-[50px] text text-[#fff] text-[14px] px-[24px] py-[10px] cursor-pointer hover:opacity-80">
						ĐĂNG NHẬP NGAY
					</div>
				</Link>
			)}
