	...
	return (
		<div className=" h-auto mt-[4.6rem] mb-[2.5rem] mx-[2.1rem] bg-back-ground-1 rounded-[1.5rem] px-[3.2rem] py-[3.2rem] shadow-shadow-custom">
			...
			{/* <div className="w-full">
				<table className="max-w-full w-[789px] block overflow-x-auto mt-[4rem]">
				...
				<table class="table-auto overflow-scroll w-full">
					<thead>
						<tr class="bg-gray-100">
							<th class="w-30 px-4 py-2">No.</th>
							<th class="w-30 px-4 py-2">First Name</th>
							<th class="w-30 px-4 py-2">Second Name</th>
							<th class="w-30 px-4 py-2">Third Name</th>
							<th class="w-30 px-4 py-2">Department</th>
							<th class="w-30 px-4 py-2">Stage</th>
							<th class="w-30 px-4 py-2">Email</th>
							<th class="w-30 px-4 py-2">Roles</th>
							<th class="w-30 px-4 py-2">status</th>
							<th class="w-30 px-4 py-2">University Email</th>
							<th class="w-30 px-4 py-2">University Password</th>
							<th class="w-30 px-4 py-2">Students Files</th>
							<th class="w-30 px-4 py-2">Actions</th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
