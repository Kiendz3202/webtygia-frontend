				...
				<table class="table-auto overflow-scroll w-full">
					<thead>
						<tr class="bg-gray-100">
							...
							<th class="w-20 px-4 py-2">First Name</th>
							<th class="w-20 px-4 py-2">Second Name</th>
							<th class="w-20 px-4 py-2">Third Name</th>
							<th class="w-20 px-4 py-2">Department</th>
							<th class="w-20 px-4 py-2">Stage</th>
							<th class="w-20 px-4 py-2">Email</th>
							<th class="w-20 px-4 py-2">Roles</th>
							<th class="w-20 px-4 py-2">status</th>
							<th class="w-20 px-4 py-2">University Email</th>
							<th class="w-20 px-4 py-2">University Password</th>
							<th class="w-20 px-4 py-2">Students Files</th>
							<th class="w-20 px-4 py-2">Actions</th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
