			...
			<div className="overflow-x-scroll w-full">
				<table className="w-[78.9rem] mt-[4rem]">
					<thead className="text-[1.4rem] font-medium h-[4.5rem] text-blue-text">
						<tr>
							<th className="w-[4.8rem] absolute h-[4.5rem] bg-back-ground-1  border-r border-grey-boder rounded-l-[0.6rem]">
								#
							</th>
							<th className="w-[16rem] absolute h-[4.5rem] bg-back-ground-1 ">
								Tên
							</th>
					...
					<tbody className="w-full">
						<tr className="text-[1.4rem] font-medium h-[4.5rem] text-start">
							<td className="w-[4.8rem] relative absolute z-10 text-center">
								1
							</td>
