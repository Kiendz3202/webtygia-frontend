				...
				data.map((coin) => (
					<div key={coin.nameId}>
						...
						<div className="mt-[3rem]">
							...
							<p className="text-[1.6rem] font-medium text-grey-text">
								Giá Bitcoin hôm nay là $16.719,10 USD với khối
								lượng giao dịch trong 24 giờ là $15.505.324.612
								USD. Chúng tôi cập nhật BTC của chúng tôi sang
								giá USD theo thời gian thực. Bitcoin giảm 1,37
								trong 24 giờ qua. Thứ hạng hiện tại trên
								CoinMarketCap là #1, với vốn hóa thị trường là
								$321.754.177.123 USD. Lượng cung lưu hành là
								19.244.712 BTC đồng coin và lượng cung tối đa là
								21.000.000 BTC đồng coin.
							</p>
						</div>
					</div>
				))}
