...
import axios from 'axios';
import { useRouter } from 'next/router';
import { useCoinDescription, useCoinPriceDetail } from '@services/coin/useCoin';
import PriceDetail from '@components/detail/coin/priceDetail';

function CoinPageDetail({ nameId }) {
	...
	const { data: dataTest } = useCoinPriceDetail(nameId);
	// console.log(data);
	return (
		<>
			<PriceDetail descriptionData={descriptionData} coin={dataTest} />
			<CoinPageDetailView descriptionData={data} />
		</>
	);
}
