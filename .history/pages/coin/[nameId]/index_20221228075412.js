					...
					<div key={coin.nameId}>
						...
						<div className="mt-[3rem]">
							...
							<p className="text-[1.6rem] font-medium text-grey-text-2">
								...
								trong 24 giờ là $15.505.324.612 USD. Chúng tôi
								cập nhật BTC của chúng tôi sang giá USD theo
								thời gian thực. {coin.nameId.toUpperCase()} giảm
								1,37 trong 24 giờ qua. Thứ hạng hiện tại trên
