					...
					<div key={coin.nameId}>
						...
						<div className="mt-[3rem]">
							...
							<p className="text-[1.6rem] font-medium text-grey-text-2">
								...
								$16.719,10 USD với khối lượng giao dịch trong 24
								giờ là $15.505.324.612 USD. Chúng tôi cập nhật
								BTC của chúng tôi sang giá USD theo thời gian
								thực. {coin.nameId.toUpperCase()} giảm 1,37
