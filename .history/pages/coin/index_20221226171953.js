			...
			<div>
				<table className="w-full">
					...
					<tbody className="text-[1.4rem] font-medium">
						<tr>
							<td className="w-[4.8rem] bg-back-ground-1  border-r border-grey-boder rounded-l-[0.6rem]">
								#
							</td>
							<td className="w-[16rem] bg-back-ground-1 ">Tên</td>
							<td className=" bg-back-ground-1 ">Giá</td>
							<td className=" bg-back-ground-1">24h%</td>
							<td className=" bg-back-ground-1">7d%</td>
							<td className=" bg-back-ground-1">
								Vốn hoá thị trường
							</td>
							<td className=" bg-back-ground-1 rounded-r-[0.6rem]">
								Khối lượng(24h)
							</td>
						</tr>
						<tr>
