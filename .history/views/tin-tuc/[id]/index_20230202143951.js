					...
					<div className=" pt-[2rem] ">
						...
						<div className="">
							{data[0]?.originSource && (
								<div className="flex">
									<a
										className="text-[1.4rem] ml-auto mr-[3rem] text-blue-500 hover:opacity-80"
										href={data[0]?.originSource}
									>
										Link bài viết gốc
									</a>
								</div>
							...
							{data[0]?.quotation && (
								<div className="flex justify-end text-[1.4rem] mr-[3rem]">
									Nguồn tham khảo: {data[0]?.quotation}
								</div>
							)}
						</div>
					</div>
