						...
						<table className="w-[78.9rem] mt-[4rem]">
							<thead className="text-[1.4rem] font-medium h-[4.5rem] text-blue-text">
								<tr>
									...
									<th className=" bg-[#F5F5F5] text-start max-w-[10rem] inline-block h-[4.5rem] leading-[4.5rem] w-[10rem]">
										Tham chiếu
									</th>
							...
							<tbody className="text-[1.4rem] font-medium h-[4.5rem] text-blue-text">
								...
								<tr>
									...
									<td className=" bg-[#F5F5F5] text-start max-w-[10rem] ">
										2.10
									</td>
									<td className=" bg-back-ground-1 text-start pr-[1rem]">
										2.20
									</td>
