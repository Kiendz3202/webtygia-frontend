				...
				<div className='className=" h-auto mt-[4.6rem] mb-[2.5rem] mx-[2.1rem] bg-white-text rounded-[1.5rem] px-[3.2rem] py-[3.2rem] shadow-shadow-custom"'>
					<div>
						...
						{/* <ChartStock
							coin={{ nameId: 'bitcoin', symbol: 'btc' }}
						/> */}
						<div className="w-full h-[10rem] text-[1.4rem] grid grid-cols-3 mt-[4rem]">
							<div className=" col-span-1">fbshb</div>
							<div className=" col-span-1">sdjfnksd</div>
							<div className=" col-span-1">kdsjhnvkg</div>
						</div>
					</div>
				</div>
			</MainLayout>
