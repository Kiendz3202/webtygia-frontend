				...
				<div className='className=" h-auto mt-[4.6rem] mb-[2.5rem] mx-[2.1rem] bg-white-text rounded-[1.5rem] px-[3.2rem] py-[3.2rem] shadow-shadow-custom"'>
					<div>
						...
						{/* <ChartStock
							coin={{ nameId: 'bitcoin', symbol: 'btc' }}
						/> */}
						<div className="mt-[3.5rem] flex justify-between flex-wrap text-center">
							<div className=" w-[2rem]">sdfnkds</div>
							<div className=" w-[2rem]">fsd</div>
							<div className=" w-[2rem]">sdfds</div>
						</div>
					</div>
				</div>
			</MainLayout>
