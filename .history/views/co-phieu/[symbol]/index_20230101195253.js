				...
				<div className='className=" h-auto mt-[4.6rem] mb-[2.5rem] mx-[2.1rem] bg-white-text rounded-[1.5rem] px-[3.2rem] py-[3.2rem] shadow-shadow-custom"'>
					<div>
						...
						{/* <ChartStock
							coin={{ nameId: 'bitcoin', symbol: 'btc' }}
						/> */}
						<div className="mt-[3.5rem] flex justify-between flex-wrap text-center text-[1.4rem]">
							<div className=" w-[2.43rem] mx-[1rem]">
								<div className="flex justify-between">
									<div>Gía đ.cửa hôm trước</div>
									<div>17</div>
								</div>
							</div>
							<div className=" w-[2.43rem] mx-[1rem]">fsd</div>
							<div className=" w-[2.43rem] mx-[1rem]">sdfds</div>
						</div>
					</div>
				</div>
			</MainLayout>
