...
function StockPageDetailView({ description }) {
	...
	return (
		<MainLayout>
			<div className='className=" h-auto mt-[4.6rem] mb-[2.5rem]  bg-white-text rounded-[1.5rem] px-[3.2rem] py-[3.2rem] shadow-shadow-custom"'>
				<div>
					<PriceDetail description={description} stock={data} />
					<ExchangeRate />
					<ChartStock stock={data && data} />
					<TablePrice stock={data && data} />
					<StockDescription
