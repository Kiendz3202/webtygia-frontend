				...
				<div className='className=" h-auto mt-[4.6rem] mb-[2.5rem] mx-[2.1rem] bg-white-text rounded-[1.5rem] px-[3.2rem] py-[3.2rem] shadow-shadow-custom"'>
					<div>
						...
						{/* <ChartStock
							coin={{ nameId: 'bitcoin', symbol: 'btc' }}
						/> */}
						<div className="mt-[3.5rem] grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-[2rem] text-center">
							<div className="">esfres</div>
							<div className="">fsd</div>
							<div className="">sdfds</div>
							<div className="">efresf</div>
