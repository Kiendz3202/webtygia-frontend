					...
					<div>
						...
						<div className=" mt-[4rem]">
							<h1 className="text-[2.4rem] text-blue-text font-medium">
								Giới thiệu về Agribank – Ngân hàng Nông nghiệp
							...
							<p className="text-[1.8rem] mt-[1rem] font-normal">
								Là một trong các ngân hàng thương mại nhà nước
								đóng vai trò chủ lực trong hệ thống ngân hàng,
								Agribank luôn phát huy vai trò tiên phong, gương
								mẫu của một Ngân hàng thương mại Nhà nước trong
								việc dẫn dắt hệ thống các tổ chức tín dụng thực
								thi nghiêm túc, có hiệu quả chính sách tiền tệ
								quốc gia và các chủ trương chính sách của Đảng,
								Nhà nước về tiền tệ, ngân hàng, nhất là chính
								sách tín dụng phục vụ phát triển nông nghiệp,
								nông thôn. Agribank đang triển khai hiệu quả 07
								chương trình tín dụng chính sách (Cho vay theo
								chính sách tín dụng phục vụ phát triển nông
								nghiệp, nông thôn; Cho vay hộ gia đình, cá nhân
								thông qua Tổ vay vốn/tổ liên kết; Cho vay theo
								chính sách hỗ trợ nhằm giảm tổn thất trong nông
								nghiệp; Cho vay gia súc, gia cầm; Cho vay tái
								canh cà phê; Cho vay chính sách phát triển thủy
								sản; Tín dụng ưu đãi phục vụ “Nông nghiệp sạch”)
								và 02 Chương trình mục tiêu Quốc gia (xây dựng
