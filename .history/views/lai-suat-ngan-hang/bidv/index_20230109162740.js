					...
					<div>
						...
						<div className=" mt-[4rem]">
							...
							<p className="text-[1.8rem] mt-[1rem] font-normal">
								...
								"Sản phẩm cho vay tiêu dùng tốt nhất Việt
								Nam"[5]. BIDV là một trong bốn ngân hàng thương
								mại, thường được gọi là Bộ Tứ (Big 4), với các
								thành viên còn lại gồm có: Ngân hàng Nông nghiệp
								và Phát triển Nông thôn Việt Nam (Agribank),
								Ngân hàng TMCP Ngoại thương Việt Nam
								(Vietcombank) và Ngân hàng TMCP Công thương Việt
								Nam (Vietinbank). Nhóm bốn ngân hàng này đều có
								quy mô tài sản, nguồn vốn, doanh thu ở nhóm hàng
								đầu và đều có Nhà nước đóng vai trò là cổ đông
								kiểm soát (với BIDV, Vietinbank, Vietcombank)
								hoặc là chủ sở hữu (với Agribank)[6]. Tại thời
								điểm tháng 4 năm 2021, BIDV và các công ty con,
								công ty liên kết (hệ thống BIDV) hoạt động chủ
								yếu trong 4 lĩnh vực: ngân hàng, bảo hiểm, chứng
								khoán và đầu tư tài chính. Hệ thống BIDV hiện
								nay có 25.000 người lao động, 190 chi nhánh,
								hiện diện tại 63 tỉnh thành của Việt Nam và tại
								6 nước khác. Các công ty con của BIDV gồm có:
								Ngân hàng Liên doanh Lào Việt (LaoViet Bank),
								Công ty cổ phần Chứng khoán Ngân hàng Đầu tư và
								Phát triển Việt Nam (BSC), Tổng Công ty cổ phần
								Bảo hiểm Ngân hàng TMCP Đầu tư và Phát triển
								Việt Nam BIDV (BIC), Công ty Bảo hiểm Lào Việt
								(LVI), Công ty Cho thuê tài chính TNHH BIDV
								(BIDV-SuMi Trust Leasing, Công ty TNHH MTV Quản
								lý nợ và khai thác tài sản BIDV (BAMC) và Ngân
