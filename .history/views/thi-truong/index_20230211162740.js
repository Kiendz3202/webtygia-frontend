			...
			<div className="px-[28px] py-[3rem]">
				...
				<div className="grid grid-cols-2 justify-items-center gap-[3rem]">
					<Link href="/gia-vang/sjc" className="block w-full h-full">
						<div className="flex flex-col p-[2rem] items-start col-span-1 shadow-xl bg-gray-400 bg-opacity-20 w-full h-[16rem] rounded-[1.5rem]">
							<div>
