	...
	return (
		<div className="p-[5rem]">
			<div className="grid grid-cols-2 justify-items-center gap-[3rem]">
				<div className="flex flex-col p-[2rem] items-start col-span-1 shadow-shadow-custom bg-slate-400 w-full h-[16rem] rounded-[1.5rem]">
					<div>
						<Avatar className="w-[5rem] h-[5rem]" />
					</div>
					<div className="text-[16px] font-semibold">Vàng</div>
				</div>
