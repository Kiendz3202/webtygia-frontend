			...
			{data && (
				<div className="mt-[4.6rem] mb-[2.5rem]">
					<div className=" grid grid-cols-7 items-center gap-x-[1rem] sm:gap-x-[2rem] mb-[2rem] px-[1rem] text-[2rem] bg-white rounded-[1.5rem] h-[5rem] shadow-shadow-custom">
						<Link className="block" href="/gia-vang/sjc">
							<div className=" col-span-1 text-center">SJC</div>
						</Link>
						<Link className="block" href="/gia-vang/pnj">
							<div className=" col-span-1 text-center">PNJ</div>
						</Link>
						<Link className="block" href="/gia-vang/doji">
							<div className=" col-span-1 text-center">DOJI</div>
						</Link>
						<Link className="block" href="/gia-vang/phu-quy-sjc">
						...
						<Link className="block" href="/gia-vang/mi-hong">
							<div className=" col-span-1 text-center">
								Mi Hồng
							</div>
						</Link>
