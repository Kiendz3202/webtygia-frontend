...
function SjcView() {
	...
	const name = 'Giá vàng SJC Việt Nam';
	console.log(data);
					...
					<div>
						...
						<div className=" mt-[4rem]">
							<h1 className="text-[2.4rem] text-blue-text font-medium">
								Giới thiệu về Công Ty TNHH Một Thành Viên Vàng
								Bạc Đá Quý Sài Gòn - SJC
							</h1>
							<p className="text-[1.8rem] mt-[1rem] font-normal">
								Được thành lập năm 1988, là doanh nghiệp nhà
								nước trực thuộc UBND TP.HCM. Hoạt động theo mô
								hình công ty mẹ - con như một tập đoàn kinh
								doanh đa ngành. Trong đó sản xuất, kinh doanh
								vàng và trang sức là ngành kinh doanh chính, địa
								ốc, đầu tư tài chính và dịch vụ.
							</p>
							<p className="text-[1.8rem] mt-[1rem] font-normal">
