		...
		<MainLayout>
			{data && (
				<div className="mt-[4.6rem] mb-[2.5rem]">
					<div className=" grid grid-cols-7 gap-x-[1rem] justify-between sm:gap-x-[2rem] mb-[2rem] px-[1rem] text-[2rem] bg-white rounded-[1.5rem] h-[5rem]">
						<div className=" col-span-1">SJC</div>
						<div className=" col-span-1">PNJ</div>
						<div className=" col-span-1">DOJI</div>
						<div className=" col-span-1">Phú Quý</div>
						<div className=" col-span-2">Bảo Tín Minh châu</div>
						<div className=" col-span-1">Mi Hồng</div>
					</div>
