		...
		<MainLayout>
			{data && (
				<div className="mt-[4.6rem] mb-[2.5rem]">
					<div className="flex justify-between flex-wrap mb-[2rem] px-[1rem] text-[2rem] bg-white rounded-[1.5rem] h-[5rem] items-center">
						<div className="mx-[1rem] bg-black">SJC</div>
						<div className="mx-[1rem]">PNJ</div>
						<div className="mx-[1rem]">DOJI</div>
						<div className="mx-[1rem]">Phú Quý</div>
						<div className="mx-[1rem]">Bảo Tín Minh châu</div>
						<div className="mx-[1rem]">Mi Hồng</div>
					</div>
