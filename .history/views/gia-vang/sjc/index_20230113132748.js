		...
		<MainLayout>
			{data && (
				<div className="mt-[4.6rem] mb-[2.5rem]">
					<div className=" grid grid-cols-7 items-center gap-x-[1rem] sm:gap-x-[2rem] mb-[2rem] px-[1rem] text-[2rem] bg-white rounded-[1.5rem] h-[5rem]">
						<div className=" col-span-1 text-center">SJC</div>
						<div className=" col-span-1 text-center">PNJ</div>
						<div className=" col-span-1 text-center">DOJI</div>
						<div className=" col-span-1 text-center">Phú Quý</div>
						<div className=" col-span-2">Bảo Tín Minh châu</div>
						<div className=" col-span-1 text-center">Mi Hồng</div>
					</div>
