				...
				<div className=" h-auto  bg-white-text rounded-[1.5rem] px-[3.2rem] py-[3.2rem] shadow-shadow-custom">
					<div>
						...
						<div className=" mt-[4rem]">
							...
							<p className="text-[1.8rem] mt-[1rem] font-normal">
								BTMC luôn nỗ lực hết mình để xứng đáng với những
								giải thưởng đã đạt được. Cũng như không ngừng
								phấn đấu vì mục tiêu mang lại những sản phẩm và
								dịch vụ tốt nhất phục vụ khách hàng.
							</p>
						</div>
					</div>
				</div>
