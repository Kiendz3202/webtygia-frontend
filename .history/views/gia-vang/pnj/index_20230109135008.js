...
function PnjView() {
	...
	const name = 'Giá vàng PNJ Việt Nam';
	console.log(data);
	return (
		<MainLayout>
			{data && (
					...
					<div>
						...
						<div className=" mt-[4rem]">
							<h1 className="text-[2.4rem] text-blue-text font-medium">
								Giới thiệu về Công ty Cổ Phần Vàng Bạc Đá Quý
								Phú Nhuận
							</h1>
							<p className="text-[1.8rem] mt-[1rem] font-normal">
								Công ty Cổ Phần Vàng Bạc Đá Quý Phú Nhuận có tên
								viết tắt là PNJ.,JSC với các ngành nghề kinh
								doanh chính:
							</p>
							<p className="text-[1.6rem] mt-[1rem] font-normal">
								-Sản xuất kinh doanh trang sức bằng vàng, bạc,
								đá quý, phụ kiện thời trang, quà lưu niệm. Kinh
								doanh đồng hồ và mua bán vàng miếng.
							</p>
							<p className="text-[1.6rem] mt-[1rem] font-normal">
								-Dịch vụ kiểm định kim cương, đá quý, kim loại
								quý.
							</p>
							<p className="text-[1.6rem] mt-[1rem] font-normal">
							...
							<p className="text-[1.8rem] mt-[1rem] font-normal">
								...
								hàng đầu tại châu Á, giữ vị trí số 1 trong các
								phân khúc thị trường trang sức trung và cao cấp
								ở Việt Nam.
							</p>
							<p className="text-[1.8rem] mt-[1rem] font-normal">
								Sứ mệnh: PNJ mang lại niềm kiêu hãnh cho khách
								hàng bằng các sản phẩm trang sức tinh tế, chất
								lượng vượt trội.
							</p>
							<p className="text-[1.8rem] mt-[1rem] font-normal">
