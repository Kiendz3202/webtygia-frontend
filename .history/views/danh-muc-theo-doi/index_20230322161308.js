			...
			<MainLayout>
				<div className=" h-auto sm:mt-[4.6rem] mb-[2.5rem]  bg-white-text rounded-[1.5rem]  lg:px-[3.2rem] py-[3.2rem] shadow-shadow-custom">
					...
					<div className=" mb-[40px]">
						<span className="pl-[10px]  text-[18px] text-blue-text font-medium">
							Tin tức
						</span>
						<NewsFollowTable
							data={data}
						...
						/>
						<span className="  bottom-[-20px] text-[12px] text-grey-text font-medium cursor-pointer hover:opacity-80">
							Xem thêm ...
						</span>
					</div>
