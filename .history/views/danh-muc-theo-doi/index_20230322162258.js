			...
			<MainLayout>
				<div className=" h-auto sm:mt-[4.6rem] mb-[2.5rem]  bg-white-text rounded-[1.5rem]  lg:px-[3.2rem] py-[3.2rem] shadow-shadow-custom">
					...
					<div className="relative mb-[40px] px-[10px]">
						...
						/>
						<div className=" absolute bottom-[-25px] w-full text-center text-[14px] text-grey-text font-medium cursor-pointer hover:opacity-80">
					...
					<div className="relative mb-[60px] px-[10px]">
						...
						/>
						<div className=" absolute bottom-[-25px]  w-full text-center text-[12px] text-grey-text font-medium cursor-pointer hover:opacity-80">
							Xem thêm <ArrowRightIcon />
						</div>
					</div>
					<div className=" mb-[40px]">
						...
						/>
						<div className="px-[10px] mt-[19px]  w-full text-center text-[12px] text-grey-text font-medium cursor-pointer hover:opacity-80">
							Xem thêm <ArrowRightIcon />
						</div>
					</div>
