		...
		<>
			<MainLayout>
				<div className=" h-auto sm:mt-[4.6rem] mb-[2.5rem]  bg-white-text rounded-[1.5rem]  lg:px-[3.2rem] py-[3.2rem] shadow-shadow-custom">
					<div className="text-[2.8rem] font-semibold mb-[50px]">
						Danh mục theo dõi
					</div>
					...
					<div className="relative mb-[40px] px-[10px]">
						...
						/>
						<span className=" absolute bottom-[-25px] text-[12px] text-grey-text font-medium cursor-pointer hover:opacity-80">
							Xem thêm <ArrowRightIcon />
						</span>
					</div>
					<div className="relative mb-[70px] px-[10px]">
						<span className=" absolute top-[5px] text-[18px] text-blue-text font-medium">
							Cổ phiếu
						</span>
						<StockFollowTable
