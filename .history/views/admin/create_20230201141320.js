...
function CreateNewsView() {
	...
	const createBlog = async () => {
		...
		try {
			...
			keyword && data.append('keyword', keyword.split(','));
			originSource && data.append('originSource', originSource);
			quotation && data.append('quotation', quotation);
			category && data.append('category', category.split(','));
			tag && data.append('tag', tag.split(','));
			nameAdminPost &&
				data.append('nameAdminPost', nameAdminPost.split(','));
			avatarAdminPost &&
				data.append('avatarAdminPost', avatarAdminPost.split(','));
