...
const useCoinDescription = (nameId) => {
	...
	return useQuery(`/coin/description/${nameId}`, fetchCoins, {
		cacheTime: 3600000,
		// refetchOnWindowFocus: false,
		staleTime: 300000,
		// refetchInterval: 5000,
...
const useCoinChart1D = (nameId, days) => {
	const fetchCoins = async () => {
		return axios
			.get(
...
export { useCoinList, useCoinPriceDetail, useCoinDescription, useCoinChart1D };
