...
function StockItem({ stock, index, user, saveStocks, deleteStocks }) {
	...
	return (
		<tr
			key={stock.name}
			className=" text-[1.6rem] text-black-text h-[4.5rem] bg-back-ground-1 rounded-3xl"
		>
			<td className="  text-center text-blue-text font-medium flex h-[4.5rem] leading-[4.5rem] justify-between">
