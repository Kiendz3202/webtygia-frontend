...
const fetchCoinChart = async (nameId) => {
	return axios
		.get(`http://localhost:5000/api/v1/coin/chart/bitcoin`)
...
function ChartCoin({ coin }) {
	...
	if (data) {
		...
		console.log(arrayChart.slice(2000));
	}
	useLayoutEffect(() => {
		...
		baselineSeries.setData([
			{ time: Date.parse('2019-04-11 09:43') / 1000, value: 82.89 },
			{ time: Date.parse('2019-04-11 12:43') / 1000, value: 81.89 },
			{ time: Date.parse('2019-04-11 13:43') / 1000, value: 83.89 },
			{ time: Date.parse('2019-04-11 14:43') / 1000, value: 80.89 },
		]);
