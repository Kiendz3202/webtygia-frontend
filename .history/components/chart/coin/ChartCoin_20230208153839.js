...
function ChartCoin({ coin }) {
	const [rangeTimeChart, setRangeTimeChart] = useState(1);

	const { data, isLoading, isError, error, isFetching } = useCoinChart(
		coin?.nameId,
		rangeTimeChart
	);
	...
	useEffect(() => {
		...
		const baselineSeries2 = chart.addBaselineSeries({
			baseValue: { type: 'price', price: 25 },
			topLineColor: 'rgba( 10, 324, 23, 1)',
			topFillColor1: 'rgba( 87, 42, 87, 0.28)',
			topFillColor2: 'rgba( 68, 45, 24, 0.05)',
			bottomLineColor: 'rgba( 24, 56, 464, 1)',
			bottomFillColor1: 'rgba( 245, 777, 35, 0.05)',
			bottomFillColor2: 'rgba( 34, 346, 25, 0.28)',
		});

		baselineSeries.setData(arrayChart);
		baselineSeries2.setData([
			{ value: 0, time: 1675845477 },
			{ value: 8, time: 1675845477 },
			{ value: 10, time: 1675845477 },
			{ value: 20, time: 1675845477 },
			{ value: 3, time: 1675843977 },
			{ value: 43, time: 1675844277 },
			{ value: 41, time: 1675844577 },
			{ value: 43, time: 1675844877 },
			{ value: 56, time: 1675845177 },
			{ value: 46, time: 1675845477 },
		]);
