		...
		<div className="flex flex-col sm:flex-row sm:h-[6rem]">
			<div className="flex items-center">
				<img
					...
					className="w-auto h-[5rem] rounded-[1000px]"
				/>
						...
						<p
							className={`${
								changePercent > 0
									...
									? 'bg-price-decrease '
									: ' bg-orange-1 '
							} text-white-text  ml-[2rem] h-[15px] text-center leading-[15px] text-center w-[47px] rounded-[2px] text-[12px]`}
						>
							{changePercent == '' ? '0,00%' : changePercent}%
						</p>
						<p className=" text-[1.4rem] text-grey-text font-normal">
