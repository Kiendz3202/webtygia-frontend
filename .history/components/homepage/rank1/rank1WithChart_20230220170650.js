			...
			<div className="mt-[3rem]">
				...
				<div className="flex">
					<div className="w-[calc(25%)]">
						<div className=" bg-grey-4 h-[120px] pl-[20px] pr-[8px] py-[10px] rounded-[10px]">
							...
							<div className="flex justify-between items-center">
								...
								<div className="w-[40px] h-[20px] text-center text-[14px] text-white bg-price-decrease rounded-[6px]">
									-2.4%
								</div>
							</div>
						</div>
