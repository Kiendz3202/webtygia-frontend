		...
		<div>
			...
			<div className="mt-[3rem]">
				...
				<div className="flex">
					...
					<div className="w-[calc(75%)] ml-[calc(2%)]">
						<div className="flex flex-wrap flex-col lg:flex-row justify-between mt-[1rem] w-full">
							{latestList &&
								latestList.map((blog, index) => (
									<div
										key={blog.timeUpdate}
										className=" px-[1rem] mb-[1rem] lg:mb-0 w-full  lg:w-1/2"
									>
										...
										<div className="flex lg:flex-col w-full ">
											...
											<div className="flex flex-col w-full lg:mt-[1rem] ml-[1rem] lg:ml-0">
												<h2
													...
													className={` lg:h-[8rem] text-[1.8rem] font-medium block`}
												>
													{blog?.title}
												</h2>
