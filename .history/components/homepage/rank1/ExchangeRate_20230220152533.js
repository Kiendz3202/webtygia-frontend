		...
		return (
			<>
				<div className="flex mt-[3.5rem] flex-col ">
					<div className="flex justify-between flex-col   bg-grey-4 rounded-[4px] py-[2rem]  px-[1rem]  h-[18rem]  w-full mr-[2rem]">
						<div className=" justify-between  flex items-center h-[5rem] rounded-[6px] border border-grey-boder">
							<div className="flex mr-[1rem] border-r-[calc(90%)] border-black-text-2  w-full h-full ">
								<input
									ref={inputVnd}
