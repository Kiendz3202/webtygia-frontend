		...
		return (
			<>
				<div className="flex mt-[3.5rem] flex-col ">
					<div className="flex justify-between flex-col   bg-grey-4 rounded-[4px] py-[2rem]  px-[1rem]  h-[12rem]  w-full mr-[2rem]">
						<div className=" justify-between  flex items-center h-[3rem] rounded-[6px] border border-grey-boder">
							<div className="mr-[1rem] border-r border-black-text-2  w-full h-[3rem] ">
								<input
									ref={inputVnd}
									onChange={convertVndToUsd}
									className="h-[3rem] outline-none text-[2rem] w-full bg-grey-4 rounded-[6px] pl-[10px]"
									placeholder="0"
								/>
							</div>
