...
const dataAgribank = {
	_id: '63c253a6202cf826a1bdd8d9',
	symbol: 'Agribank',
	khongkyhanBusiness: '0.5',
	khongkyhanPersonal: '0.5',
	month10Business: '5.8',
	month10Personal: '6.1',
	month11Business: '5.8',
	month11Personal: '6.1',
					...
					<div className="w-[calc(74%)] ml-[calc(1%)]">
						...
						<div className="flex items-center">
							...
							<div className="ml-[1rem]">
								<h1 className="text-[2.4rem] font-semibold capitalize text-back-text w-fit">
							...
							{user?.followExchangeRates?.includes(data?._id) ? (
								...
								/>
										...
										<BookmarkBorderIcon
											// onClick={() => saveExchangeRate(data?._id)}
											className="text-[2rem] cursor-pointer hover:opacity-80 ml-[1rem]"
										/>
									</p>
								</h1>
							</div>
						</div>
						<AgribankPriceTable data={dataAgribank} />
					</div>
				</div>
			</div>
		</div>
