			...
			<div className="mt-[3rem]">
				...
				<div className="flex">
					<div className="w-[calc(25%)]">
						<div className=" bg-grey-4 h-[120px] pl-[20px] pr-[8px] py-[10px]">
							<div className="flex justify-between border-b border-grey-boder">
								<div className="flex items-center">
									<img
										className="h-[32px] w-[32px] rounded-[1000px] mr-[4px]"
					...
					<div className="w-[calc(75%)]">vdcsv</div>
				</div>
			</div>
		</div>
	);
