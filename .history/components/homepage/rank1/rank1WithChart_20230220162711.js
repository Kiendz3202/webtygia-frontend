...
function Rank1WithChart() {
	return (
		<div>
			...
			<div>
				<p className="text-[20px] font-semibold">Quan tâm gần đây</p>
				<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 mt-[2rem] bg-grey-4 rounded-[10px] h-[105px] overflow-hidden">
