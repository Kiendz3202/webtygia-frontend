					...
					latestList.map((blog, index) => (
						...
						>
							...
							<div className="flex lg:flex-col w-full ">
								<Link
									className="relative w-full max-w-[16rem] lg:max-w-[24rem]"
								...
								>
									{/* <img
										...
										src={blog?.image}
									/> */}
									{/* <div className="relative w-[16rem] h-[16rem]  lg:w-[24rem] lg:h-[13rem] object-cover "> */}
									<Image
										src={blog?.image}
										fill
										style={{
										...
										className="w-[16rem] h-[16rem]  lg:w-[24rem] lg:h-[13rem]"
										// width={240}
										// height={130}
									/>
									{/* </div> */}
