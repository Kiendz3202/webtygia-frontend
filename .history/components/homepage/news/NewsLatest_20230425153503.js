						...
						>
							...
							<div className="flex lg:flex-col w-full ">
								...
								<div className="flex flex-col w-full lg:mt-[1rem] ml-[1rem] lg:ml-0">
									<h2
										className={`${styles.lineClamp2} lg:h-[6rem] text-[1.8rem] font-medium block`}
									>
										{blog?.title}
									</h2>
									<div className=" mb-[0.5rem] lg:h-[4.2rem]">
										<p
											className={`${styles.lineClamp3}  text-[1.4rem] text-grey-text-2`}
										>
											{blog?.description}
										</p>
									</div>
									<div className="mt-[2rem] lg:h-[56px]">
										<div className="flex items-center h-full">
											...
											<div className="ml-[10px]">
												...
												<div className="flex items-center text-[1.4rem] text-grey-text-2 font-medium">
													29/10/2022
												</div>
											</div>
										</div>
