		...
		<div className="flex justify-between">
			{data &&
				[1, 2, 3, 4].map((stock, index) => (
					<div
						key={index}
						className="bg-[#F5F5F5] w-full mx-[8px] h-[120px] px-[10px] py-[5px]"
					>
						<div className="flex justify-between items-center pb-[4px] border-b border-grey-boder">
							<div className="flex items-center">
								<div>
									<div className="text-[16px] font-medium text-blue-text">
										AAV
									</div>
									<div className="text-[8px]">VND</div>
								</div>
							</div>
						...
						<div className="flex justify-between items-center mt-[6px]">
							<div className="text-[28px] font-medium">26000</div>
