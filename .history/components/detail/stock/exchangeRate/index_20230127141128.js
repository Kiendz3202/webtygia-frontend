		...
		return (
			<>
				...
				<div className="flex justify-between flex-col sm:flex-row mt-[3.5rem] bg-grey-4 rounded-[4px] py-[1.7rem] px-[3.8rem] h-[6rem]">
					<div className=" justify-between ml-[3rem]  flex items-center h-[3rem] border-grey-boder border-[1px]">
					...
					<div className=" justify-between ml-[3rem] flex items-center h-[3rem]">
						<div className="mr-[1rem] border-r border-black-text-2 w-full">
							<input
								ref={inputUsd}
