		...
		return (
			<>
				...
				<div className="flex mt-[3.5rem] flex-col lg:flex-row">
					<div className="flex justify-between flex-col lg:flex-row  bg-grey-4 rounded-[4px] py-[2rem] lg:py-[1.7rem] px-[1rem] lg:px-[3.8rem] h-[11rem] lg:h-[6rem] w-full mr-[2rem]">
