		...
		return (
			<>
				...
				<div className="flex mt-[3.5rem]">
					<div className="flex justify-between flex-col sm:flex-row  bg-grey-4 rounded-[4px] py-[1.7rem] px-[3.8rem] h-[6rem]">
					...
					<div className="leading-[6rem]">
						<Box className=" min-w-[10rem] h-[6rem] mt-[2rem] sm:mt-0 ">
