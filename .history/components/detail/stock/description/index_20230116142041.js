...
function StockDescription({ description }) {
	return (
		<div className="mt-[3rem]">
			...
			<p className="text-[2rem] mt-[1rem] font-medium text-grey-text-2">
				{description?.description}
			</p>
			<h3 className="text-[2.4rem] font-semibold text-back-text mt-[2rem]">
				Thông tin liên lạc
			</h3>
			<div className="w-full text-[1.8rem] text-grey-text-2 font-medium mt-[1.5rem]">
				<div className="flex justify-between px-[1rem] my-[1rem]">
					<div>
						<LocationOnIcon className="mr-[1rem]" />
						Địa chỉ
					</div>
					<div className=" max-w-[20rem]">{description?.address}</div>
				</div>
				<div className="flex justify-between px-[1rem] my-[1rem] ">
					<div>
