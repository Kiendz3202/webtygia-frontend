						...
						<div
							className={`${
								+stock.changePercent.slice(0, -1) > 0
									? 'bg-price-increase text-white-text'
									: +stock.changePercent.slice(0, -1) < 0
									? 'bg-price-decrease text-white-text'
									: ' bg-orange-1 text-black-text-2'
							}  ml-[2rem] h-[3rem] text-center leading-[3rem] w-fit rounded-[0.6rem] text-[1.4rem]`}
						>
							{+stock.changePercent.slice(0, -1) > 0 ? '+' : ''}
							{stock.changePercent == ''
								? '0%'
