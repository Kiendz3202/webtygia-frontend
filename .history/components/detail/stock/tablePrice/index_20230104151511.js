...
function TablePrice({ stock }) {
	return (
		<div className=" text-[1.4rem] grid grid-cols-2 mt-[4rem] sm:grid-cols-3 font-medium gap-y-[3rem] gap-x-[1rem] ">
			<div className=" col-span-1 grid grid-cols-3 ">
				...
				<div className=" col-span-1 ">
					<div className=" p-[0.8rem] h-[5.8rem] justify-items-center">
						{stock.openPrice}
					</div>
			...
			<div className=" col-span-1 grid grid-cols-3 ">
				...
				<div className=" col-span-1">
					...
					<div className=" p-[0.8rem] h-[5.8rem] whitespace-nowrap">
