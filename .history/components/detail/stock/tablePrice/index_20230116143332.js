...
function TablePrice({ stock }) {
	return (
		<div className=" overflow-x-auto sm:overflow-visible">
			<div className=" min-w-[70rem]  text-[1.8rem] grid grid-cols-2 mt-[4rem] sm:grid-cols-3 font-medium gap-y-[3rem] gap-x-[3rem] sm:gap-x-[1.5rem] ">
				...
				<div className=" col-span-1 grid grid-cols-3 ">
					<div className=" col-span-2 ">
						<div className=" w-fit p-[0.8rem] h-[5.8rem]">
