...
function TablePrice({ stock }) {
	return (
		...
		// 				<div className=" p-[0.8rem] h-[5.8rem]" className='đ text-[#8D8D8D]'>Mở cửa</div>
			...
			<div className="grid grid-cols-4 gap-4">
				<div>
					<div className="mb-[2rem]">
						<div className="đ text-[#8D8D8D]">Mở cửa</div>
						<div className="text-[20px] font-medium">
							{stock?.openPrice}
						</div>
					</div>
					<div className="mb-[2rem]">
						<div className="đ text-[#8D8D8D]">Thấp nhất</div>
						<div className="text-[20px] font-medium">
							{stock?.low}
						</div>
					</div>
					<div className="mb-[2rem]">
						<div className="đ text-[#8D8D8D]">Cao nhất</div>
						<div className="text-[20px] font-medium">
							{stock?.high}
						</div>
					</div>
					<div className="mb-[2rem]">
						<div className="đ text-[#8D8D8D]">Tham chiếu</div>
						<div className="text-[20px] font-medium">
							{stock?.reference}
						</div>
					</div>
