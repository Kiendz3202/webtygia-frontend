...
function TablePrice({ stock }) {
	return (
		<div className=" text-[1.8rem] grid grid-cols-2 mt-[4rem] sm:grid-cols-3 font-medium gap-y-[3rem] gap-x-[2rem] ">
			<div className=" col-span-1 grid grid-cols-3 ">
				...
				<div className=" col-span-1">
					...
					<div className=" p-[0.8rem] h-[5.8rem]">{stock?.low}</div>
					<div className=" p-[0.8rem] h-[5.8rem]">{stock?.high}</div>
					<div className=" p-[0.8rem] h-[5.8rem]">
						{stock?.reference}
					</div>
				</div>
			...
			<div className=" col-span-1 grid grid-cols-3 ">
				<div className=" col-span-2">
					...
					<div className=" p-[0.8rem] h-[5.8rem]">Cao 52 tuần</div>
					<div className=" p-[0.8rem] h-[5.8rem]">Thấp 52 tuần</div>
					<div className=" p-[0.8rem] h-[5.8rem]">
						Giá thay đổi 1 tuần
					</div>
				</div>
			...
			<div className=" col-span-1 grid grid-cols-3 ">
				...
				<div className=" col-span-1">
					<div
						className={` ${
							+stock?.percentPriceChange1Month.slice(0, -1) > 0
								? 'text-price-increase'
								: 'text-price-decrease'
						} p-[0.8rem] h-[5.8rem] whitespace-nowrap`}
					>
					...
					<div
						className={` ${
							+stock?.percentPriceChange3Month.slice(0, -1) > 0
								? 'text-price-increase'
								: 'text-price-decrease'
						} p-[0.8rem] h-[5.8rem] whitespace-nowrap`}
					>
					...
					<div
						className={` ${
							+stock?.percentPriceChange6Month.slice(0, -1) > 0
								? 'text-price-increase'
								: 'text-price-decrease'
						} p-[0.8rem] h-[5.8rem] whitespace-nowrap`}
					>
