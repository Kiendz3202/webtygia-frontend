...
function VietcombankPriceTable({ data }) {
	return (
		<div className="w-full">
			...
			<div className="grid grid-cols-4 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				<div className=" col-span-2 p-[1rem]">48 tháng</div>
				<div className=" col-span-2 p-[1rem]">{data?.month48}</div>
			</div>
			<div className="grid grid-cols-4 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				<div className=" col-span-2 p-[1rem]">60 tháng</div>
				<div className=" col-span-2 p-[1rem]">{data?.month60}</div>
			</div>
		</div>
	);
}
