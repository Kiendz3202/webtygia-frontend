...
function ManyBanksPriceTable() {
	return (
		<div className="w-full overflow-x-auto mt-[2rem]">
			<div className="flex   text-center min-w-[80rem] text-[1.6rem] font-medium text-blue-text bg-grey-4 rounded-[4px]">
			...
			<div className="flex   text-center min-w-[80rem] text-[1.6rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
