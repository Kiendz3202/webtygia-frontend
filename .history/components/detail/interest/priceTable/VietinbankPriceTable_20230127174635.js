...
function VietinbankPriceTable({ data }) {
	return (
		<div className="w-full mt-[2rem] text-[1.7rem]">
			<div className="grid grid-cols-6 gap-x-[2rem] text-[1.8rem] font-medium text-blue-text bg-grey-4 rounded-[4px]">
			...
			<div className="grid grid-cols-6 gap-x-[2rem]  font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
