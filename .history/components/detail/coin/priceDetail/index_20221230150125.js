...
// import useGetFetchQuery from '@services/coin/useGetCoinList';
import useCoinList from '@services/coin/useCoinList';

function PriceDetail({ coin }) {
	// const data = useGetFetchQuery('coinList');
	// console.log(data);
				...
				<div>
					...
					<div className="flex justify-around flex-wrap max-w-[28.3rem] text-[1.4rem] font-medium">
						...
						<div className="flex p-[0.5rem] m-[0.5rem] bg-back-ground-1 rounded-lg cursor-pointer hover:opacity-80 items-center">
							...
							<span className="px-[0.5rem]">Mã nguồn</span>
							<OpenInNewIcon sx={{ fontSize: '2rem' }} />
						</div>
						<div className="flex p-[0.5rem] m-[0.5rem] bg-back-ground-1 rounded-lg cursor-pointer hover:opacity-80 items-center">
							<PersonIcon sx={{ fontSize: '2rem' }} />
							<span className="px-[0.5rem]">Cộng đồng</span>
							<OpenInNewIcon sx={{ fontSize: '2rem' }} />
						</div>
					</div>
				</div>
