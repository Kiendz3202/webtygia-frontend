		...
		<div className="  pb-[4rem]">
			<div className="flex flex-col sm:flex-row justify-between">
				<div>
					...
					<div className="flex justify-around flex-wrap max-w-[28.3rem] text-[1.4rem]">
						<div className="flex p-[0.5rem] m-[0.5rem] bg-back-ground-1 rounded-lg cursor-pointer hover:opacity-80">
							<LinkIcon />
							Trang chủ
							<OpenInNewIcon />
						</div>
						<div className="flex p-[0.5rem] m-[0.5rem] bg-slate-400 rounded-lg cursor-pointer hover:opacity-80">
							<GitHubIcon />
							ma nguon
							<OpenInNewIcon />
						</div>
