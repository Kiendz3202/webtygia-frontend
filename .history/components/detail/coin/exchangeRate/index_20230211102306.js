...
function ExchagneRate({ data }) {
	...
	return (
		<>
			...
			<div className="flex justify-between flex-col lg:flex-row  rounded-[4px] bg-grey-4">
				<div className=" justify-between ml-[3rem] mr-[3rem] flex items-center">
					...
					<div className="flex h-[5rem] lg:h-[10rem] items-center w-[9rem]">
						<img
							src={data?.image}
				...
				<div className="flex items-center w-[3rem] ml-[2rem] lg:ml-0">
					<SyncAltIcon sx={{ fontSize: '3rem' }} />
				</div>
				<div className=" justify-between ml-[3rem] mr-[3rem] lg:mr-[6rem]  flex items-center ">
					...
					<div className="flex h-[6rem] lg:h-[10rem] items-center w-[9rem]">
						<img
