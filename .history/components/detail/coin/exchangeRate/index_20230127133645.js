...
function ExchagneRate({ data }) {
	...
	return (
		<>
			...
			<div className="flex justify-between flex-col sm:flex-row  rounded-[4px]">
				...
				<div className="flex items-center w-[3rem] mx-[2rem]">
					<SyncAltIcon sx={{ fontSize: '3rem' }} />
				</div>
				<div className=" justify-between  sm:mr-[3rem] flex items-center">
