	...
	return (
		<>
			...
			<div className="flex justify-between flex-col sm:flex-row">
				<div className=" w-full justify-between ml-[3rem] flex items-center">
					...
					<div className="flex h-[10rem] items-center w-[5rem]">
						<img
							src={data.image}
				...
				<div className=" w-full justify-between ml-[3rem] sm:mr-[3rem] flex items-center">
					...
					<div className="flex w-[5rem] h-[10rem] items-center ">
						<img
							src="https://assets.coingecko.com/coins/images/325/large/Tether.png?1668148663"
							className="w-[3.2rem] h-[3.2rem]"
						/>
						<div className="ml-[1rem]">
							<h1 className="text-[1.8rem] font-semibold capitalize text-black-text w-fit">
								Tether
								<p className=" text-[1.4rem] text-grey-text ">
									USDT
								</p>
