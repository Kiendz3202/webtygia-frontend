	...
	return (
		<div className="w-full">
			...
			<div className="grid grid-cols-4 gap-x-[2rem] text-[1.6rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-1 p-[1rem]">{data?.ron92II_1}</div>
				<div className=" col-span-1 p-[1rem]">{data?.ron92II_2}</div>
			</div>
			<div className="grid grid-cols-4 gap-x-[2rem] text-[1.6rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				<div className=" col-span-2 p-[1rem]">DO 0,001S-V</div>
				<div className=" col-span-1 p-[1rem]">{data?.do0001SV_1}</div>
				<div className=" col-span-1 p-[1rem]">{data?.do0001SV_2}</div>
			</div>
			<div className="grid grid-cols-4 gap-x-[2rem] text-[1.6rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				<div className=" col-span-2 p-[1rem]">DO 0,05S-II</div>
				<div className=" col-span-1 p-[1rem]">{data?.do005SII_1}</div>
				<div className=" col-span-1 p-[1rem]">{data?.do005SII_2}</div>
			</div>
			<div className="grid grid-cols-4 gap-x-[2rem] text-[1.6rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				<div className=" col-span-2 p-[1rem]">Dầu hỏa 2-K</div>
				<div className=" col-span-1 p-[1rem]">{data?.dauhoa_1}</div>
				<div className=" col-span-1 p-[1rem]">{data?.dauhoa_2}</div>
			</div>
		</div>
	);
}
