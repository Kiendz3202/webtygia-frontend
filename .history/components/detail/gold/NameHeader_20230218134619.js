				...
				<h1 className="text-[2.4rem] sm:text-[2.8rem] font-semibold capitalize text-back-text w-fit">
					...
					<p className=" text-[1.4rem] text-grey-text">
						...
						<span className="ml-[1rem]">
							<BookmarkBorderIcon className="text-[2.4rem] cursor-pointer hover:opacity-80" />
							<BookmarkIcon className="text-[2.4rem] text-green-500 cursor-pointer hover:opacity-80" />
						</span>
					</p>
				</h1>
			</div>
