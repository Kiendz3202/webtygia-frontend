	...
	return (
		<div className=" overflow-x-auto">
			<div className="w-full min-w-[60rem]">
				...
				<div className=" grid grid-cols-8 gap-x-[2rem] text-[1.8rem] font-medium ">
				...
				<div className=" grid grid-cols-8 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
