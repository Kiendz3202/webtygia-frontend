...
function SjcPriceTable({ data }) {
	return (
		<div className="w-full">
			...
			<div className="grid grid-cols-5 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
			...
			<div className="grid grid-cols-5 items-start gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				<div className=" col-span-1 p-[1rem]"></div>
			...
			<div className="grid grid-cols-5 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-2 p-[1rem]">Vàng SJC 1L - 10L</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lMienTayBuy / 1000000}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lMienTaySell / 1000000}
				</div>
			</div>
			<div className="grid grid-cols-5 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-2 p-[1rem]">Vàng SJC 1L - 10L</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lQuangNgaiBuy / 1000000}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lQuangNgaiSell / 1000000}
				</div>
			</div>
			<div className="grid grid-cols-5 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-2 p-[1rem]">Vàng SJC 1L - 10L</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lLongXuyenBuy / 1000000}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lLongXuyenSell / 1000000}
				</div>
			</div>
			<div className="grid grid-cols-5 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-2 p-[1rem]">Vàng SJC 1L - 10L</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lBacLieuBuy / 1000000}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lBacLieuSell / 1000000}
				</div>
			</div>
			<div className="grid grid-cols-5 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-2 p-[1rem]">Vàng SJC 1L - 10L</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lQuyNhonBuy / 1000000}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lQuyNhonSell / 1000000}
				</div>
			</div>
			<div className="grid grid-cols-5 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-2 p-[1rem]">Vàng SJC 1L - 10L</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lPhanRangBuy / 1000000}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lPhanRangSell / 1000000}
				</div>
			</div>
			<div className="grid grid-cols-5 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-2 p-[1rem]">Vàng SJC 1L - 10L</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lHaLongBuy / 1000000}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lHaLongSell / 1000000}
				</div>
			</div>
			<div className="grid grid-cols-5 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-2 p-[1rem]">Vàng SJC 1L - 10L</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lQuangNamBuy / 1000000}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.sjc1l10lQuangNamSell / 1000000}
				</div>
			</div>
		</div>
	);
