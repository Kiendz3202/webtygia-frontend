...
function BidvPriceTable({ data }) {
	return (
		<div className="w-full">
			...
			<div className="grid grid-cols-4 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
			...
			<div className="grid grid-cols-4 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-1 p-[1rem]">
					{data?.myrBuyCast > 1000
						? parseFloat(data?.myrBuyCast).toLocaleString()
						: data?.myrBuyCast}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.myrBuyTransfer > 1000
			...
			<div className="grid grid-cols-4 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				...
				<div className=" col-span-1 p-[1rem]">
					{data?.rubBuyCast > 1000
						? parseFloat(data?.rubBuyCast).toLocaleString()
						: data?.rubBuyCast}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.rubBuyTransfer > 1000
			...
			<div className="grid grid-cols-4 gap-x-[2rem] text-[1.8rem] font-normal border border-opacity-30 border-grey-text rounded-[1rem] mt-[1rem]">
				<div className=" col-span-1 p-[1rem]">TWD</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.twdBuyCast > 1000
						? parseFloat(data?.twdBuyCast).toLocaleString()
						: data?.twdBuyCast}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.twdBuyTransfer > 1000
						? parseFloat(data?.twdBuyTransfer).toLocaleString()
						: data?.twdBuyTransfer}
				</div>
				<div className=" col-span-1 p-[1rem]">
					{data?.twdSell > 1000
						? parseFloat(data?.twdSell).toLocaleString()
						: data?.twdSell}
				</div>
			</div>
		</div>
