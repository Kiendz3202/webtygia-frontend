		...
		<div className="overflow-x-auto w-full">
			<table className="w-[104rem] mt-[4rem] border-separate border-spacing-y-[4px]">
				<thead className="text-[1.8rem] font-medium h-[4.5rem] text-blue-text ">
					<tr>
						<th className="w-[25rem] bg-back-ground-1  rounded-[0.6rem] border-b-[8px]  border-white">
							Ngân hàng
						</th>
						<th className="w-[20px] bg-white h-auto border-b-[8px]  border-white"></th>
						<th className=" bg-back-ground-1 text-center border-b-[8px]  border-white">
							Mua tiền mặt
						</th>
						<th className=" bg-back-ground-1 text-center border-b-[8px]  border-white">
							Mua chuyển khoản
