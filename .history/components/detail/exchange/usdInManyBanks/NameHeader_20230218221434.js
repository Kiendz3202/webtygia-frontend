...
function NameHeader({
	...
	return (
		<div className="flex h-[7.5rem] sm:h-[6rem]">
			...
			<div className=" flex items-center ml-auto text-[4rem] font-semibold ">
				<div>{data && data?.usdSell}</div>
				...
				<div
					className={`${
						changePercent > 0
							...
							? 'bg-price-decrease '
							: ' bg-orange-1 '
					} text-white-text  ml-[2rem] h-[3rem] text-center leading-[3rem] w-[5.5rem] rounded-[0.6rem] text-[1.2rem]`}
				>
					{/* {changePercent > 0 ? '+' : ''} */}
