...
function NameHeader(
	...
	return (
		<div className="flex h-[7.5rem] sm:h-[6rem]">
			...
			<div className=" items-center ml-auto text-[2.8rem] font-semibold text-center ">
				<div>23,56.00</div>
				<div className="bg-price-increase text-white-text  ml-[2rem] h-[3rem] text-center leading-[3rem] w-[5rem] rounded-[0.6rem] text-[1.4rem]">
					0.54%
				</div>
				{/* <div
					className={`${
