...
function NavigationHeader() {
	...
	return (
		<nav className="hidden sm:flex items-center sticky top-0 mx-[1rem] w-[144rem] sm:mx-0 shadow-shadow-custom bg-white min-h-[65px] z-50">
			<div className="  w-full flex items-center mx-auto">
				<div className="flex  justify-between items-center text-grey-text">
					<Link href="/trang-chu" className="mr-[1rem]">
						<div
							className={` px-[1.5rem] py-[1rem] h-fit  text-[1.8rem] font-normal text-center align-middle   cursor-pointer  ${
					...
					<Link href="/coin" className="mr-[1rem]">
						<div
							className={` px-[1.5rem] py-[1rem] text-[2rem] font-normal text-center align-middle   cursor-pointer mx-1 ${
					...
					<Link href="/co-phieu/hnx" className="mr-[1rem]">
						<div
							className={` px-[1.5rem] py-[1rem] text-[1.8rem] font-normal text-center align-middle   cursor-pointer mx-1 ${
