...
function NavigationHeader() {
	...
	return (
		<div className=" sticky top-0 w-full mx-auto flex   items-center bg-white shadow-shadow-custom   z-50 mt-[1rem] mx-auto">
			<ul className="flex flex-wrap max-w-[144rem]  justify-between items-center text-grey-text p-3">
