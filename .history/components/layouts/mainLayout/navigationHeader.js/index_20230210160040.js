...
function NavigationHeader() {
	...
	return (
		<div className="hidden sm:block sticky top-0 mx-[1rem]  sm:mx-0 shadow-shadow-custom bg-white h-[65px] z-50">
			<div className="  w-full max-w-[144rem] flex   items-center my-auto mx-auto">
