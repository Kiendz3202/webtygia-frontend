...
function NavigationHeader() {
	...
	return (
		<div className="sticky top-0 shadow-shadow-custom">
			<div className=" sticky top-0 w-full max-w-[144rem] flex   items-center bg-white shadow-shadow-custom   z-50 mt-[1rem] mx-auto">
