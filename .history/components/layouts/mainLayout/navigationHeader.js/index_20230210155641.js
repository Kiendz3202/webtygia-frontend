...
function NavigationHeader() {
	...
	return (
		<div className="hidden sm:block sticky top-0 mx-[1rem] pb-[1rem] sm:mx-0 border-b-[1px] border-grey-boder bg-white z-50">
			<div className="  w-full max-w-[144rem] flex   items-center px-[1rem]  mx-auto">
