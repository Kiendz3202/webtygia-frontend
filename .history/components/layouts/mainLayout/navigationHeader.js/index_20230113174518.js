			...
			<div className="  w-full max-w-[144rem] flex   items-center mt-[1rem] mx-auto">
				<ul className="flex flex-wrap  justify-between items-center text-grey-text p-3">
					<Link href="/gia-vang/sjc" className="mr-[1rem]">
						<li
							className={`w-fit px-[1rem] py-[1rem] h-fit  text-[1.8rem] font-normal text-center align-middle   cursor-pointer  ${
					...
					<Link href="/co-phieu" className="mr-[1rem]">
						<li
							className={`w-fit px-[1rem] py-[1rem] text-[1.8rem] font-normal text-center align-middle   cursor-pointer mx-1 ${
					...
					<Link href="/coin" className="mr-[1rem]">
						<li
							className={`w-fit px-[1rem] py-[1rem] text-[2rem] font-normal text-center align-middle   cursor-pointer mx-1 ${
