...
function Header() {
	...
	return (
		...
		>
			<div className="  w-full max-w-[144rem] items-center flex justify-between h-[6rem] items-center ">
				...
				<div className="flex h-[4rem]">
					...
					<div className="flex relative items-center justify-between bg-white w-auto rounded-[25px] ml-[15px]">
						...
						<div className="flex items-center justify-end ml-[2.5rem] mr-[1rem] text-[#868697]">
							...
							/>
							{isOpenModal && (
								<div className="hidden md:block absolute top-[52px] right-0 z-[1000] text-[14px] w-[25rem] bg-white shadow-2xl rounded-[5px]">
									<div
										onClick={toggleOpenModal}
