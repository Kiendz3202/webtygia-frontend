							...
							{avatar ? (
								<>
									...
									<li className=" mx-[3rem] relative">
										...
										/>
										{isOpenModal && (
											<div className="hidden md:block absolute -bottom-[250px] -left-[20rem] z-[1000] text-[14px] w-[25rem] bg-white shadow-2xl ">
												<div
													onClick={toggleModal}
												...
												<div
													onClick={logout}
													className="text-grey-text text-[16px] pb-[2rem] px-[3.2rem] hover:opacity-80 cursor-pointer"
												>
													Đăng xuất
												</div>
											</div>
