			...
			<div className="  w-full max-w-[144rem] flex justify-between h-[7.8rem] items-center ">
				...
				<div className=" flex flex-1  h-[7.8rem] items-center ">
					<div className="hidden sm:flex flex-1 sm:ml-[5rem] ">
						<ul className="flex w-full px-[2rem] py-[2rem] rounded-full bg-[#3A3B3C]">
							<li>
								<label htmlFor="search">
									<SearchIcon
										sx={{ fontSize: '3rem' }}
										className=" text-[3rem] cursor-pointer text-grey-text"
									/>
								</label>
							</li>
							<li className=" w-full mr-[3rem] text-grey-text">
								<input
									id="search"
									className=" w-full outline-none text-[2.0rem] bg-[#3A3B3C] text-grey-text"
									type="text"
