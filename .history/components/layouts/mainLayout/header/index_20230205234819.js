									...
									<Link href="/ca-nhan">
										<li className=" mx-[3rem] relative">
											<Avatar
												...
												src={avatar}
											/>
											<div className=" absolute -bottom-[210px] -left-[20rem] z-[1000] text-[14px] w-[25rem] bg-white shadow-2xl px-[2rem]">
												<div className=" text-end mr-[10px] cursor-pointer hover:opacity-80">
													<CloseIcon />
												</div>
												<div>
													<div className="flex">
