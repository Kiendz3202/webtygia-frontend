			...
			<div className="  w-full max-w-[144rem] my-auto flex justify-between h-[6rem] items-center px-[28px] lg:px-0">
				...
				<div className="flex h-[4rem]">
					...
					{email ? (
						...
						<div className="flex relative items-center justify-between bg-white shadow-shadow-custom w-auto rounded-[8px] ml-[9px] sm:ml-[15px]">
							<div>
								<LoginIcon sx={{ fontSize: '2rem' }} />
							</div>
							<div className="text-[14px]">Đăng nhập/Đăng ký</div>
						</div>
					)}
