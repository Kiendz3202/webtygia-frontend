...
function Header() {
	...
	return (
		...
		>
			<div className="  w-full max-w-[144rem] my-auto flex justify-between h-[6rem] items-center px-[1rem]">
				...
				<div className="flex h-[4rem]">
					...
					<div className="flex items-center justify-center w-[4rem] rounded-[1000px] bg-white ml-[5px] sm:ml-[15px] cursor-pointer hover:opacity-80">
						<NotificationsNoneIcon
							sx={{ fontSize: '2rem', color: '#868697' }}
						/>
					</div>
					<div className="flex relative items-center justify-between bg-white w-auto rounded-[25px] ml-[5px] sm:ml-[15px]">
						<img
							className="w-[4rem] h-full rounded-[1000px]"
							src={
								avatar
									? avatar
									: 'https://www.google.com/imgres?imgurl=https%3A%2F%2Fcdn.pixabay.com%2Fphoto%2F2013%2F07%2F13%2F10%2F07%2Fman-156584_960_720.png&imgrefurl=https%3A%2F%2Fpixabay.com%2Fvectors%2Fman-person-avatar-face-head-156584%2F&tbnid=cYBiruIYIWbRUM&vet=12ahUKEwisqaqMz4z9AhUbvVYBHaG-CO8QMygTegUIARDoAQ..i&docid=3uMEKAivk_1AmM&w=873&h=720&q=person%20avatar&ved=2ahUKEwisqaqMz4z9AhUbvVYBHaG-CO8QMygTegUIARDoAQ'
							}
						/>
						<div className="flex items-center justify-end ml-[0.5rem] md:ml-[2.5rem] mr-[1rem] text-[#868697]">
							...
							/>
							{isOpenModal && (
								<div className="hidden md:block absolute top-[55px] right-0 z-[1000] text-[14px] w-[25rem] bg-white shadow-2xl rounded-[5px]">
									<div
										onClick={toggleOpenModal}
