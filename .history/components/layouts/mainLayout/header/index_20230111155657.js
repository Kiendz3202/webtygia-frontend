...
function Header() {
	...
	return (
		<header id="header" className=" sm:fixed w-full top-0  z-50 ">
			<div className="  w-full max-w-[144rem] flex justify-between h-[7.8rem] items-center bg-white-text shadow-shadow-custom">
			...
			<div className="  w-full max-w-[144rem] flex justify-between  items-center bg-white-text shadow-shadow-custom rounded-[1.5rem] mt-[1rem]">
