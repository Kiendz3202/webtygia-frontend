			...
			<div className="  w-full max-w-[144rem] flex   items-center  ">
				<ul className="flex flex-wrap  justify-between items-center text-grey-text p-3">
					<Link href="/gia-vang/sjc" className="my-[0.5rem]">
						<li
							className={`w-fit px-[2rem] h-[5rem] text-[2rem] font-normal text-center align-middle  leading-[5rem] cursor-pointer mx-1  ${
					...
					<Link href="/co-phieu" className="my-[0.5rem]">
						<li
							className={`w-[11rem] h-[5rem] text-[2rem] font-normal text-center align-middle  leading-[5rem] cursor-pointer mx-1 ${
