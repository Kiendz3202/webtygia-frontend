...
function Header() {
	...
	return (
		...
		>
			<div className="  w-full max-w-[144rem] flex justify-between h-[7.8rem] items-center ">
				...
				<div className=" flex flex-1  h-[7.8rem] items-center ">
					<div className="hidden sm:flex flex-1 sm:ml-[5rem] ">
						<ul className="flex w-full px-[2rem] py-[0.7rem] mr-[2.7rem] rounded-full bg-grey-4">
							<li>
							...
							<li className=" w-full mr-[3rem] ">
								<input
									id="search"
									className=" w-full outline-none text-[2.0rem] bg-grey-4"
									type="text"
			...
			<div className="  w-full max-w-[144rem] flex   items-center shadow-shadow-custom mt-[1rem]">
				<ul className="flex flex-wrap  justify-between items-center text-grey-text p-3">
					<Link href="/gia-vang/sjc" className="mr-[1rem] mt-[1rem]">
						<li
					...
					<Link href="/co-phieu" className="mr-[1rem] mt-[1rem]">
						<li
					...
					<Link href="/coin" className="mr-[1rem] mt-[1rem]">
						<li
							className={`w-fit px-[2rem] text-[2rem] font-normal text-center align-middle  leading-[5rem] cursor-pointer mx-1 ${
					...
					<Link href="/gia-xang-dau" className="mr-[1rem] mt-[1rem]">
						<li
							className={`w-fit px-[2rem] text-[2rem] font-normal text-center align-middle  leading-[5rem] cursor-pointer mx-1 ${
					...
					<Link href="/tin-tuc" className="mr-[1rem] mt-[1rem]">
						<li
							className={`w-fit px-[2rem] text-[2rem] font-normal text-center align-middle  leading-[5rem] cursor-pointer mx-1 ${
					...
					{/* <Link href="/danh-muc-theo-doi" className="mr-[1rem] mt-[1rem]">
						<li
