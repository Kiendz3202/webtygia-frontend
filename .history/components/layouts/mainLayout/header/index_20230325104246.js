				...
				<div className="flex h-[4rem]">
					...
					<div className="flex relative items-center justify-between bg-white w-auto rounded-[25px] ml-[9px] sm:ml-[15px]">
						<Avatar
							...
							src={avatar ? avatar : ''}
						/>
						<div className="hidden sm:flex items-center justify-end ml-[0.5rem] sm:ml-[2.5rem] mr-[1rem] text-[#868697]">
							{email ? (
							...
							<div
								...
								} transition-all ease-linear duration-100 hidden sm:block absolute top-[55px] right-0 z-[1000] text-[14px] w-[25rem] bg-white shadow-2xl rounded-[5px]`}
							>
								<div
									onClick={closeModal}
