...
function Header() {
	...
	return (
		<header
			id="header"
			className=" sm:fixed w-full top-0  z-50 bg-white-text rounded-[1.5rem] shadow-shadow-custom"
		>
			...
			<div className="  w-full max-w-[144rem] flex justify-between  items-center">
