...
function Header() {
	...
	return (
		<header id="header" className=" sm:fixed w-full top-0  z-50 ">
			<div className="  w-full max-w-[144rem] flex justify-between h-[7.8rem] items-center bg-white-text shadow-shadow-custom rounded-t-[1.5rem]">
				<div className="flex h-[7.8rem] items-center  sm:pl-[0.1rem] cursor-pointer   pl-[2rem] sm:border-grey-boder sm:border-b">
					<Link href="/">
						<svg
							className="ml-[3rem]"
							width="130"
				...
				<div className=" flex flex-1  h-[7.8rem] items-center  sm:border-grey-boder sm:border-b">
			...
			<div className="sm:hidden flex border-b border-grey-boder h-[7.8rem] items-center bg-back-ground-1">
			...
			<div className="  w-full max-w-[144rem] flex justify-between  items-center bg-white-text shadow-shadow-custom rounded-t-[1.5rem]">
				<ul className="flex flex-wrap items-center text-grey-text p-3">
					<Link href="/" className="mt-[1.4rem]">
						<li
							className={`w-[13rem] h-[5rem] text-[1.8rem] text-center align-middle  leading-[5rem] cursor-pointer mx-2 ${
					...
					<Link href="/danh-muc-theo-doi" className="mt-[1.4rem]">
						<li
							className={`w-[16rem] h-[5rem] text-[1.8rem] text-center align-middle  leading-[5rem] cursor-pointer mx-2 ${
