...
function Header() {
	...
	return (
		...
		>
			...
			<div className="  w-full max-w-[144rem] flex   items-center bg-white-text shadow-shadow-custom rounded-[1.5rem] ">
				<ul className="flex flex-wrap  justify-between items-center text-grey-text p-3">
					<Link href="/" className="my-[0.5rem]">
						<li
							className={`w-[13rem] h-[5rem] text-[2rem] font-medium text-center align-middle  leading-[5rem] cursor-pointer mx-1 ${
					...
					<Link href="/gia-vang/sjc" className="my-[0.5rem]">
						<li
							className={`w-[13rem] h-[5rem] text-[2rem] font-medium text-center align-middle  leading-[5rem] cursor-pointer mx-2  ${
					...
					{/* <Link href="/danh-muc-theo-doi" className="my-[0.5rem]">
						<li
							className={`w-[16rem] h-[5rem] text-[2rem] font-medium text-center align-middle  leading-[5rem] cursor-pointer mx-2 ${
