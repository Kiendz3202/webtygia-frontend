...
function Header() {
	...
	return (
		...
		>
			<div className="  w-full max-w-[144rem] my-auto flex justify-between h-[6rem] items-center px-[1rem] lg:px-0">
				...
				<div className="flex h-[4rem]">
					...
					<div
						...
						className="hidden relative sm:flex lg:hidden items-center justify-center ml-[9px] cursor-pointer hover:opacity-80"
					>
						<svg
							width="23"
							height="16"
						...
						<NavigationHeaderMenu isOpenMenu={isOpenMenu} />
					</div>
				</div>
			</div>
		</header>
