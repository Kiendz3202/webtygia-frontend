					...
					>
						...
						{listSearch && searchTerm && (
							<div
								...
								} absolute left-0 top-[6rem] z-[1000] w-[200px] sm:w-[400px] h-fit max-h-[500px] bg-white text-black rounded-[4px] shadow-shadow-custom border border-grey-boder overflow-y-scroll`}
							>
						...
						{noResult && (
							<div className=" absolute left-0 top-[6rem] z-[1000] w-[200px] sm:w-[400px] h-fit max-h-[500px] bg-white text-black rounded-[4px] shadow-shadow-custom border border-grey-boder overflow-y-scroll">
								<div className="flex items-center w-full px-[20px] py-[10px] h-[50px] hover:bg-grey-boder">
									<div className="text-[16px] ml-[20px]">
