			...
			<div className="  w-full max-w-[144rem] flex justify-between  items-center ">
				<ul className="flex flex-wrap items-center text-grey-text p-3">
					<Link href="/" className="mt-[1.4rem]">
						<li
							className={`w-[16rem] h-[5rem] text-[1.8rem] text-center align-middle  leading-[5rem] cursor-pointer ${
					...
					<Link href="/gia-vang/sjc" className="mt-[1.4rem]">
						<li
							className={`w-[12rem] h-[3.6rem] text-[1.6rem] pl-[1.2rem] leading-[3.6rem] cursor-pointer  ${
					...
					<Link href="/lai-suat-ngan-hang" className="mt-[1.4rem]">
						<li
							className={`w-[16rem] h-[3.6rem] text-[1.6rem] pl-[1.2rem] leading-[3.6rem] cursor-pointer ${
					...
					<Link href="/ty-gia-ngoai-te" className="mt-[1.4rem]">
						<li
							className={`w-[13rem] h-[3.6rem] text-[1.6rem] pl-[1.2rem] leading-[3.6rem] cursor-pointer ${
