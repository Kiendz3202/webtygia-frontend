			...
			<div className="  w-full max-w-[144rem] my-auto flex justify-between h-[6rem] items-center px-[28px] lg:px-0">
				...
				<div className="flex h-[4rem]">
					...
					>
						...
						<div className=" absolute left-0 top-[6rem] z-[1000] w-[400px] bg-white text-black rounded-[4px] shadow-shadow-custom">
							{listSearch &&
								listSearch.map((item) => (
									<Link href={item.href}>
										<div className="flex items-center w-full px-[20px] py-[10px] h-[50px] hover:bg-grey-text-2">
											{item.image && (
												<img
													src={item.image}
