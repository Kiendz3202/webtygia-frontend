	...
	return (
		<header id="header" className="sm:fixed w-full top-0  z-50 bg-white">
			...
			<div className="  w-full max-w-[144rem] flex justify-between  items-center bg-white-text shadow-shadow-custom rounded-[1.5rem] ">
				<div className="flex justify-between text-grey-text p-3">
					<Link href="/" className="my-[0.5rem] block">
						<div
							className={` h-[5rem] text-[1.8rem] text-center align-middle  leading-[5rem] cursor-pointer mx-2 ${
					...
					<Link href="/gia-vang/sjc" className="my-[0.5rem] block">
						<div
							className={` h-[5rem] text-[1.8rem] text-center align-middle  leading-[5rem] cursor-pointer mx-2  ${
