...
function MenuSideBar() {
	...
	return (
		<div className="hidden xl:block w-[18.7rem] ml-[2rem] mt-[5.7rem] xl:fixed top-[7.8rem] bg-white-text shadow-shadow-custom rounded-[1rem] h-[50rem]">
