						...
						<div className="grid grid-cols-2  lg:grid-cols-3 gap-8">
							<div className="">
								<div class="kilimanjaro_part">
									...
									<p className="text-[13px]">
										Trang web cung cấp thông tin đầy đủ và
										chính xác từ các nguồn tin uy tín, giúp
										người dùng có thể đưa ra quyết định đầu
										tư thông minh và hiệu quả. Với Tygia24h,
										bạn sẽ không bỏ lỡ bất kỳ tin tức quan
										trọng nào về các tài sản đầu tư mình
										quan tâm.
									</p>
								</div>
							</div>
