	...
	return (
		<div>
			<div className="relative">
				<Header />
				<div className=" sticky top-0 w-full max-w-[144rem] flex   items-center bg-white shadow-shadow-custom rounded-[1.5rem]  z-50 mt-[1rem] mx-auto">
					<ul className="flex flex-wrap  justify-between items-center text-grey-text p-3">
						<Link href="/gia-vang/sjc" className="mr-[1rem]">
							<li
								className={`w-fit px-[2rem] h-fit  text-[2rem] font-normal text-center align-middle   cursor-pointer  ${
