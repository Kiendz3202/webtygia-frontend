		...
		<div className="hidden md:block w-[31.8rem] ">
			<div className="pt-[1.5rem] pl-[1.7rem] shadow-shadow-custom rounded-[1rem]">
				...
				<div className="pt-[1.5rem]">
					<ul className="grid grid-cols-3 justify-between text-grey-text text-[1.4rem] font-semibold">
						<li>Mã</li>
						<li>Giá</li>
						<li>Thay đổi</li>
					</ul>
				...
				<div className="pt-[1.5rem] text-[1.6rem]">
					...
					<div>
						<ul className="grid grid-cols-3 justify-between text-grey-text text-[1.4rem]">
