...
function GoldNavigation() {
	...
	return (
		<div className=" grid grid-cols-4 sm:grid-cols-7  gap-x-[1rem] sm:gap-x-[2rem] mb-[2rem] text-[2rem] bg-white rounded-[1.5rem] h-[10rem] sm:h-[5rem] shadow-shadow-custom">
