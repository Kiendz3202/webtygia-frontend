...
function InterestRateNavigation() {
	...
	return (
		<div className=" grid grid-cols-7 items-center gap-x-[1rem] sm:gap-x-[2rem] mb-[2rem] px-[1rem] text-[2rem] bg-white rounded-[1.5rem] h-[10rem] sm:h-[5rem] shadow-shadow-custom">
