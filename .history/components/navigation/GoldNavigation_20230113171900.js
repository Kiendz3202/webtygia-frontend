...
function GoldNavigation() {
	...
	return (
		<div className=" flex  flex-wrap items-center gap-x-[1rem]  mb-[2rem] text-[1.6rem] bg-white rounded-[1.5rem]  shadow-shadow-custom">
			<div className="  w-fit h-[5rem]   ">
				<Link
					className={`flex w-full h-full px-[1rem] mx-[1rem] text-center items-center scale-[1.05] ${
			...
			<div className="  w-fit h-[5rem]  ">
				<Link
					className={`flex w-full px-[1rem] mx-[1rem] h-full text-center items-center  scale-[1.05] ${
